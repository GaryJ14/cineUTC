...
SECRET_KEY = 'django-insecure-v4ajothhb#0mzh9fepvyvv3^noxnk@hv0!8@$g#i_utb$5w05_'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# ALLOWED_HOSTS = []
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', 'cineutc-wt2d.onrender.com').split(',')
...
#Configuracion de la carpeta ara gestionar archivos estaticos
STATIC_URL = '/static/'
